...
import 'package:fusion_wallet/ui/pages/primary/contacts/add_contact.dart';
...
//                    borderRadius: BorderRadius.zero,
                    ...
                    hintText: AppLocalizations.of(context).inputFeedbackCommentHint(),
                  ),
                ),
              ),
            ),
...
//                    borderRadius: BorderRadius.zero,
                    ...
                    hintText: AppLocalizations.of(context).labelFeedbackEmailSubtitle(),
                  ),
                ),
              ),
            ),
    ...
    final sendButton = Container(
      ...
      child: FusionButton(text: AppLocalizations.of(context).buttonSend(),
          onPressed:() {
