...
class _CreateInvoiceUiState extends State<CreateInvoiceUi> {
  ...
  void initState() {
    ...
    Future.delayed(const Duration(milliseconds: 700), () {
      store.fetchInitials(account: StateContainer.of(context).selectedAccount);
    });
  ...
  Widget build(BuildContext context) {
    ...
    return FusionScaffold(
      title: AppLocalizations.of(context).createInvoiceTitle(),
      child: Padding(
            ...
            children: [
              ...
              Flexible(
                  ...
                  child: Container(
                    child: Center(
                      child: FusionButton(
                          text: AppLocalizations.of(context).createInvoiceBtn(),
                          expandedWidth: true,
                          onPressed: () async {
                            await store.post();
  ...
  Widget _buildNetworkDropdown(BuildContext context) {
    return Padding(
      ...
      child: DropdownSearch<String>(
          ...
          popupShape:
              OutlineInputBorder(borderRadius: FusionTheme.borderRadius),
      ...
      child: Container(
        child: Observer(
          builder: (_) {
            ...
            if (future == null) return PlatformCircularProgressIndicator();
...
//                    borderRadius: BorderRadius.zero,
          ...
          helperText: AppLocalizations.of(context)
              .maximumQtyLabel(store.maximum.toString()),
        ),
      ));
  ...
  Widget _buildCardInput(BuildContext context) => Padding(
        ...
        child: TextFormField(
          ...
          onChanged: (value) => store.enterCard(value),
          inputFormatters: [
