...
Last updated: June 07, 2020
    ...
    return FusionScaffold(
      ...
      child: Container(
        ...
        child: ListView(
          children: [
            Center(child: Text ("Privacy Policy", style: TextStyle( fontSize: 20, fontWeight: FontWeight.bold ),)),
            Text (privacyPolicy, style: TextStyle( fontSize: 16, )),
            Text ("1. Information We Collect", style: TextStyle( fontSize: 20, fontWeight: FontWeight.bold ),),
            Text (informationWeCollect, style: TextStyle( fontSize: 16, )),
            Text ("2. Cookies and Other Tracking Technologies", style: TextStyle( fontSize: 20, fontWeight: FontWeight.bold ),),
            Text (cookieAndOther, style: TextStyle( fontSize: 16, )),
            Text ("3. Legal Bases to Process Personal Data", style: TextStyle( fontSize: 20, fontWeight: FontWeight.bold ),),
            Text (legalBases, style: TextStyle( fontSize: 16, )),
            Text ("4. Why We Process Personal Data", style: TextStyle( fontSize: 20, fontWeight: FontWeight.bold ),),
            Text (whyWeProcessPersonalData, style: TextStyle( fontSize: 16, )),
            Text ("5. How Long We Retain Information", style: TextStyle( fontSize: 20, fontWeight: FontWeight.bold ),),
            Text (howLong, style: TextStyle( fontSize: 16, )),
            Text ("6. How Long We Retain Information", style: TextStyle( fontSize: 20, fontWeight: FontWeight.bold ),),
            Text (howLong, style: TextStyle( fontSize: 16, )),
            Text ("7. How Long We Retain Information", style: TextStyle( fontSize: 20, fontWeight: FontWeight.bold ),),
            Text (howLong, style: TextStyle( fontSize: 16, )),
            Text ("8. How Long We Retain Information", style: TextStyle( fontSize: 20, fontWeight: FontWeight.bold ),),
            Text (howLong, style: TextStyle( fontSize: 16, )),
            Text ("9. International Data Transfers", style: TextStyle( fontSize: 20, fontWeight: FontWeight.bold ),),
            Text (howLong, style: TextStyle( fontSize: 16, )),
            Text ("10. Modifications", style: TextStyle( fontSize: 20, fontWeight: FontWeight.bold ),),
            Text (howLong, style: TextStyle( fontSize: 16, )),
            Text ("11. Privacy Related Inquiries", style: TextStyle( fontSize: 20, fontWeight: FontWeight.bold ),),
            Text (howLong, style: TextStyle( fontSize: 16, )),
