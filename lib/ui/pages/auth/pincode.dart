  ...
  void _handleKeypadClick(String val, BuildContext context) {
    ...
    if (_otp.length == 6) {
      if (pincode != null && pincode == _otp) {
        FlashHelper.successBar(context, message: AppLocalizations.of(context).successfullySavedPin());
        ...
        if(pincode != null && pincode != _otp)
          FlashHelper.errorBar(context, message: AppLocalizations.of(context).errorOnPinInput());
        setState(() {
          this.pincode = _otp;
          this._otp = "";
          this._otpSymbols = [
