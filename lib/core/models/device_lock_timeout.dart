  ...
  String getDisplayName(BuildContext context) {
    switch (setting) {
      case LockTimeoutOption.ZERO:
        return AppLocalizations.of(context).instantly;
      case LockTimeoutOption.ONE:
        return AppLocalizations.of(context).xMinute.replaceAll("%1", "1");
      case LockTimeoutOption.FIVE:
        return AppLocalizations.of(context).xMinutes.replaceAll("%1", "5");
      case LockTimeoutOption.FIFTEEN:
        return AppLocalizations.of(context).xMinutes.replaceAll("%1", "15");
      case LockTimeoutOption.THIRTY:
        return AppLocalizations.of(context).xMinutes.replaceAll("%1", "30");
      case LockTimeoutOption.SIXTY:
        return AppLocalizations.of(context).xMinutes.replaceAll("%1", "60");
      default:
        return AppLocalizations.of(context).xMinute.replaceAll("%1", "1");
    }
  }
